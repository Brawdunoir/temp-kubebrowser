...
type KubeconfigLister interface {
	...
	List(selector labels.Selector) (ret []*kubeconfigv1.Kubeconfig, err error)
...
type kubeconfigLister struct {
	listers.ResourceIndexer[*kubeconfigv1.Kubeconfig]
}

// NewKubeconfigLister returns a new KubeconfigLister.
func NewKubeconfigLister(indexer cache.Indexer) KubeconfigLister {
	return &kubeconfigLister{listers.New[*kubeconfigv1.Kubeconfig](indexer, kubeconfigv1.Resource("kubeconfig"))}
}

// Kubeconfigs returns an object that can list and get Kubeconfigs.
func (s *kubeconfigLister) Kubeconfigs(namespace string) KubeconfigNamespaceLister {
	return kubeconfigNamespaceLister{listers.NewNamespaced[*kubeconfigv1.Kubeconfig](s.ResourceIndexer, namespace)}
}
...
type KubeconfigNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kubeconfigv1.Kubeconfig, error)
