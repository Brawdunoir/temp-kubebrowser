...
type ClusterApplyConfiguration struct {
	...
	Cluster *DetailsApplyConfiguration `json:"cluster,omitempty"`
}
...
func (b *ClusterApplyConfiguration) WithCluster(value *DetailsApplyConfiguration) *ClusterApplyConfiguration {
	b.Cluster = value
	return b
}
